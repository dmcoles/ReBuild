...
eSourceGen.m:			eSourceGen.e fileStreamer.m sourceGen.m reactionObject.m
							$(compiler) eSourceGen $(options)

cSourceGen.m:			cSourceGen.e fileStreamer.m sourceGen.m reactionObject.m
							$(compiler) cSourceGen $(options)

sourceGen.m:			sourceGen.e fileStreamer.m
...
menuObject.m:			menuObject.e reactionObject.m reactionForm.m stringlist.m fileStreamer.m
