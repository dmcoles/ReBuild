  ...
  self.windowObj:=WindowObject,
    ...
    LAYOUT_DEFERLAYOUT, TRUE,
      ...
      LAYOUT_ADDCHILD, LayoutObject,
        ...
        IntegerEnd,
        CHILD_LABEL, LabelObject,
          LABEL_TEXT, IF arrows THEN 'Width' ELSE 'Wid',
        LabelEnd,
        ...
        IntegerEnd,
        CHILD_LABEL, LabelObject,
          LABEL_TEXT, IF arrows THEN 'Height' ELSE 'Hght',
        LabelEnd,
      ...
      LAYOUT_ADDCHILD, LayoutObject,
        ...
        IntegerEnd,
        CHILD_LABEL, LabelObject,
          LABEL_TEXT, IF arrows THEN 'MinDepth' ELSE 'MinDep',
        LabelEnd,
        ...
        IntegerEnd,
        CHILD_LABEL, LabelObject,
          LABEL_TEXT, IF arrows THEN 'MaxDepth' ELSE 'MaxDep',
        LabelEnd,
      LayoutEnd,
      ...
      LAYOUT_ADDCHILD, LayoutObject,
        ...
        IntegerEnd,
        CHILD_LABEL, LabelObject,
          LABEL_TEXT, IF arrows THEN 'InfoLeftEdge' ELSE 'InfoLeft',
        LabelEnd,
        ...
        IntegerEnd,
        CHILD_LABEL, LabelObject,
          LABEL_TEXT, IF arrows THEN 'InfoTopEdge' ELSE 'InfoTop',
        LabelEnd,
      ...
      LAYOUT_ADDCHILD, LayoutObject,
        ...
        ChooserEnd,
        CHILD_LABEL, LabelObject,
          LABEL_TEXT, IF arrows THEN 'Over_ScanType' ELSE 'O_Scan',
        LabelEnd,
    ...
    'VGAEXTRALORESHAM_KEY','VGAPRODUCTHAMLACE_KEY',0]),
        ChooserEnd,
        CHILD_LABEL, LabelObject,
          LABEL_TEXT, IF arrows THEN 'Display_ID' ELSE 'Disp_ID', 
        LabelEnd,
      LayoutEnd,
