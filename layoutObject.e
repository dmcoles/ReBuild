...
EXPORT PROC createPreviewObject() OF layoutObject
  ...
  self.previewObject:=LayoutObject,
        ...
        IF self.bevelState THEN LAYOUT_BEVELSTATE ELSE TAG_IGNORE, ListItem([-1,IDS_SELECTED,IDS_NORMAL],self.bevelState),
        LAYOUT_LABEL,self.label,
        LAYOUT_LABELPLACE, ListItem([PLACETEXT_LEFT,PLACETEXT_RIGHT],self.labelPlace),
      ...
      LAYOUT_ADDCHILD, LayoutObject,
        ...
        LAYOUT_ADDCHILD, LayoutObject,
          ...
          LAYOUT_ADDCHILD, self.gadgetList[ LAYOUTGAD_BEVELSTATE ]:=ChooserObject,
            ...
            CHOOSER_ACTIVE, 0,
            CHOOSER_WIDTH, -1,
            CHOOSER_LABELS, self.labels3:=chooserLabelsA(['NONE', 'IDS_SELECTED','NORMAL',0]),
          ChooserEnd,
          CHILD_LABEL, LabelObject,
        ...
        LAYOUT_ADDCHILD, LayoutObject,
          ...
          LAYOUT_ADDCHILD, self.gadgetList[ LAYOUTGAD_LABELPLACE ]:=ChooserObject,
            ...
            CHOOSER_ACTIVE, 0,
            CHOOSER_WIDTH, -1,
            CHOOSER_LABELS, self.labels4:=chooserLabelsA(['PLACETEXT_LEFT', 'PLACETEXT_RIGHT',0]),
          ChooserEnd,
          CHILD_LABEL, LabelObject,
